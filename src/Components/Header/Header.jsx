                ...
                <SwiperSlide>
                    <div className={headerCSS.Header_slide}>
                        <div className={headerCSS.header_content}>
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa, repudiandae? Inventore, modi non. Rem quisquam delectus quibusdam voluptates</p>
                            <button>Let&apos;s Collabrorate <i className="ri-arrow-right-up-line"></i></button>
                        </div>
